...
The Solr that as of this writing is distributed with Blacklight is not actually 1.4, but a pre-1.4 nightly build that does not include TrieIntFields.  The old deprecated sint or slong types should work fine too. 
