!function(global) {
  ...
  var BlacklightRangeLimit = {
    // ratio of width to height for desired display, multiply width by this ratio
    // to get height. hard-coded in for now.
    display_ratio: 1/(1.618 * 2), // half a golden rectangle, why not
    redrawnEvent: "plotDrawn.blacklight.rangeLimit"
  };
  ...
  // again, if needed.
  BlacklightRangeLimit.redrawPlot = function (container) {
  ...
  //
  // We also will
  BlacklightRangeLimit.turnIntoPlot = function (container, wait_for_visible) {
